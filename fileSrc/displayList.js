...
export function displayPeople(myPeople) {
  ...
  sortedPeople.sort((a, b) => {
    let dayToBirthdayA = differenceInCalendarDays(
      getNextBirthday(a.birthday),
      new Date()
    )
    let dayToBirthdayB = differenceInCalendarDays(
      ...
      return `
                            <ul class="list_container">
                                ...
                                <li class="list_item title_container">
                                    <span class="name">${person.lastName} ${
        person.firstName
      }</span>
                                    ${
                                      daysToBirthday == 0
                                ...
                                <li class="list_item">
                                    <span class="future_birthday daysleft">${
                                      daysToBirthday === 0
                                        ? `🎂🎂🎂`
