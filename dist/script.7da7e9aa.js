...
exports.body = exports.filterByMonthSelect = exports.filterInputName = exports.parent = exports.container = void 0;
...
exports.body = body;
},{}],"fileSrc/utils.js":[function(require,module,exports) {
"use strict";
...
function getNextBirthday(birthday) {
  ...
  let nextBirthDay = (0, _dateFns.setYear)(birthdayDate, today.getFullYear()); // if it's today, we return the value
...
function showScroll() {
  _variables.body.style.overflow = 'visible';
}
},{"date-fns":"node_modules/date-fns/esm/index.js","waait":"node_modules/waait/index.js","./variables":"fileSrc/variables.js"}],"fileSrc/svgs.js":[function(require,module,exports) {
"use strict";
...
const deleteIcon = `<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M26.25 5H10L1.25 15L10 25H26.25C26.913 25 27.5489 24.7366 28.0178 24.2678C28.4866 23.7989 28.75 23.163 28.75 22.5V7.5C28.75 6.83696 28.4866 6.20107 28.0178 5.73223C27.5489 5.26339 26.913 5 26.25 5V5Z" stroke="#EF4565" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
const editIcon = `<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.75 4H4C3.33696 4 2.70107 4.26339 2.23223 4.73223C1.76339 5.20107 1.5 5.83696 1.5 6.5V24C1.5 24.663 1.76339 25.2989 2.23223 25.7678C2.70107 26.2366 3.33696 26.5 4 26.5H21.5C22.163 26.5 22.7989 26.2366 23.2678 25.7678C23.7366 25.2989 24 24.663 24 24V15.25" stroke="#094067" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M22.125 2.12499C22.6223 1.62771 23.2967 1.34834 24 1.34834C24.7033 1.34834 25.3777 1.62771 25.875 2.12499C26.3723 2.62227 26.6517 3.29673 26.6517 3.99999C26.6517 4.70325 26.3723 5.37771 25.875 5.87499L14 17.75L9 19L10.25 14L22.125 2.12499Z" stroke="#094067" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
exports.editIcon = editIcon;
const iconClose = `<svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
...
exports.deletePersonPopup = exports.deletePerson = void 0;
...
const deletePersonPopup = person => {
  return new Promise(async resolve => {
    ...
    const html = `
            <fieldset class="fieldset_delete">
                ...
                <h5>
                    Delete <b>${person && person.firstName} ${person && person.lastName}</b> 🙈    </h5>
...
},{"./displayList":"fileSrc/displayList.js","./localStorage":"fileSrc/localStorage.js","./utils":"fileSrc/utils.js","./svgs":"fileSrc/svgs.js","waait":"node_modules/waait/index.js"}],"fileSrc/edit.js":[function(require,module,exports) {
"use strict";
...
// edit person data
async function editPeople(id, myPeople) {
  const person = myPeople.find(person => person.id === id);
...
async function editPeoplePopup(person) {
  return new Promise(async resolve => {
    ...
    form.addEventListener('submit', e => {
      ...
      person.lastName = e.target.lastName.value; // use this date conversion to get a timestamp back (just like the birthday inside people.json)
...
},{"./displayList":"fileSrc/displayList.js","./utils":"fileSrc/utils.js","./localStorage":"fileSrc/localStorage.js","./svgs":"fileSrc/svgs.js","waait":"node_modules/waait/index.js"}],"fileSrc/add.js":[function(require,module,exports) {
"use strict";
...
},{"./localStorage":"fileSrc/localStorage.js","./delete":"fileSrc/delete.js","./edit":"fileSrc/edit.js","./add":"fileSrc/add.js","./displayList":"fileSrc/displayList.js","./variables":"fileSrc/variables.js","./utils":"fileSrc/utils.js"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","fileSrc/script.js"], null)
